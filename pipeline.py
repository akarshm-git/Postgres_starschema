...
def main():
    ...
    conn = psycopg2.connect("host=localhost dbname=sparkifydb user=akarsh password=admin12345")
    cur = conn.cursor()
    ...
    #get_files function is used to get a list of all songs JSON files on data/song_data
    ...
    process_data(cur, conn, filepath='Postgres_starschema/data/song_data', func=process_song_file)
    process_data(cur, conn, filepath='Postgres_starschema/data/log_data', func=process_log_file)
